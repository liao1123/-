...
if __name__ == "__main__":
    # 提取MUGE test集特征
    # python -u cn_clip/eval/extract_features_train_test_valid.py  --extract-image-feats  --extract-text-feats  --image-data="datapath/datasets/MUGE/lmdb/test/imgs"  --text-data="datapath/datasets/MUGE/test_texts.jsonl"  --image-feat-output-path="datapath/feature/MUGE_feature/test_img_feature.jsonl"  --text-feat-output-path="datapath/feature/MUGE_feature/test_text_feature.jsonl"  --img-batch-size=32  --text-batch-size=32  --context-length=52  --resume=datapath/pretrained_weights/clip_cn_vit-b-16.pt  --vision-model=ViT-B-16  --text-model=RoBERTa-wwm-ext-base-chinese
    # 提取MUGE valid集特征
    # python -u cn_clip/eval/extract_features_train_test_valid.py  --extract-image-feats  --extract-text-feats  --image-data="datapath/datasets/MUGE/lmdb/valid/imgs"  --text-data="datapath/datasets/MUGE/valid_texts.jsonl"  --image-feat-output-path="datapath/feature/MUGE_feature/valid_img_feature.jsonl"  --text-feat-output-path="datapath/feature/MUGE_feature/valid_text_feature.jsonl"  --img-batch-size=32  --text-batch-size=32  --context-length=52  --resume=datapath/pretrained_weights/clip_cn_vit-b-16.pt  --vision-model=ViT-B-16  --text-model=RoBERTa-wwm-ext-base-chinese
    # 提取MUGE train集特征
    # python -u cn_clip/eval/extract_features_train_test_valid.py  --extract-image-feats  --extract-text-feats  --image-data="datapath/datasets/MUGE/lmdb/train/imgs"  --text-data="datapath/datasets/MUGE/train_texts.jsonl"  --image-feat-output-path="datapath/feature/MUGE_feature/train_img_feature.jsonl"  --text-feat-output-path="datapath/feature/MUGE_feature/train_text_feature.jsonl"  --img-batch-size=32  --text-batch-size=32  --context-length=52  --resume=datapath/pretrained_weights/clip_cn_vit-b-16.pt  --vision-model=ViT-B-16  --text-model=RoBERTa-wwm-ext-base-chinese
    args = parse_args()
