...
def GenG(key: str, blocksize):
    ...
    def G(raw: int) -> bytes:
        ...
        return cipher.crypt_ecb(tep)

    return G


def G(raw, cipher, blocksize):
    """
...
class Label:
    ...
    def Enc(self, K, L):
        ...
        cipher1 = sm4.CryptSM4()
        cipher1.set_key(self.K1.encode('utf-8'), sm4.SM4_ENCRYPT) # F
        cipher2 = sm4.CryptSM4()
        cipher2.set_key(self.K2.encode('utf-8'), sm4.SM4_ENCRYPT) # P
        cipher3 = sm4.CryptSM4()
        cipher3.set_key(self.K3.encode('utf-8'), sm4.SM4_ENCRYPT) # Pi
        cipher4 = sm4.CryptSM4()
        cipher4.set_key(self.K4.encode('utf-8'), sm4.SM4_ENCRYPT) # G
...
class User:
    ...
    def Token(self, K: SSECMRKey, w: str) -> Tuple[int, int]:
        ...
        cipher1 = sm4.CryptSM4()
        cipher1.set_key(K.K1.encode('utf-8'), sm4.SM4_ENCRYPT) # F
        cipher2 = sm4.CryptSM4()
        cipher2.set_key(K.K2.encode('utf-8'), sm4.SM4_ENCRYPT) # P
